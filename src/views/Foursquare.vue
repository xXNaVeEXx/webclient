      ...
      <v-form @submit="onSubmit" v-model="valid">
        <v-container fill-height fluid>
          <v-row align="center" justify="center" align-content="center">
            <v-col cols="12" md="4">
              <v-text-field v-model="category" :rules="fieldRules" label="Category" required></v-text-field>
            </v-col>
          </v-row>
          <v-row align="center" justify="center" align-content="center">
            <v-col cols="12" md="4">
              <v-text-field v-model="radius" :rules="fieldRules" label="Radius" required></v-text-field>
            </v-col>
          </v-row>
          ...
          <v-row justify="center" align="center" align-content="center">
            <v-col cols="12" md="4">
              <v-card class="mx-auto" max-width="400">
                <div v-bind:key="category.id" v-for="category in item.venue.categories">
                  <v-img
                ...
                <v-card-actions>
                  ...
                  <v-btn
                    color="orange"
                    v-on:click="getMap(item.venue.location.address,item.venue.name )"
                    text
                  >Maps</v-btn>
                </v-card-actions>
              </v-card>
